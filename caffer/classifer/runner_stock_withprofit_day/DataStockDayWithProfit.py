...
# FileName: DataStockDayWithProfit.py
...
class DataStockDayWithProfit(Data):
    def __init__(self, config):
        if not config:
            self.bail(-1, "no config: DataStockDayWithProfit init")
        self.config = config
        self.debug = config["debug"]
        super(DataStockDayWithProfit, self).__init__(config)
        print "DataStockDayWithProfit"
