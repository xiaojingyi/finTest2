...
# FileName: Runner.py
# Date: 2016 Sat 09 Jul 2016 12:02:09 AM CST
# Encoding: utf-8
...
class Runner(App):
    ...
    def mkNet(self, margin=1, dropout=0.5):
        ...
        netname = f.init("NetStockDays", {"margin": margin, "dropout": dropout}, "gpu%d_" % self.gpu_id + "alex.prototxt")
        return netname
