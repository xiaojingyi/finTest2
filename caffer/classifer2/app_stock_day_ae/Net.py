...
class Net(object):
    ...
    def atomLayers(self, bottom, label, label_muti, onelen, loss_num=1.0):
        points = [7 + onelen]
        ...
        fc = self.net_model.fcLayer(concat, 2048, t="xavier", 
                replace='relu', dropout=self.dropout)
        fc = self.net_model.fcLayer(fc, 2048, t="xavier",
                replace='relu', dropout=self.dropout)
